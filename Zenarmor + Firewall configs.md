<h1>🔐 Firewall Rules - LAN de Usuários</h1>
...
Definir quem pode acessar o quê (Web, DNS, e-mails, etc.).

Permitir saída para o proxy se ele for transparente ou explícito.

<b>3️⃣ Regras de Firewall – Servidores (VLAN 20):</b>

Permitir apenas os serviços necessários (ex.: Wazuh, atualizações, SSH, etc.).
